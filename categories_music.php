...
function getMusicCategories() {
    global $mysqli_conn;
    $sql = "SELECT id, name, slug, parent_id FROM categories WHERE name = 'Music' OR parent_id = (SELECT id FROM categories WHERE name = 'Music') ORDER BY name";
...
<div class="flex">
    ...
    <div class="w-64 bg-white p-4 shadow-md">
        ...
        <div class="music-categories">
            <h4 class="font-bold mb-2">Music</h4>
            <?php 
            $musicCategories = getMusicCategories();
            $mainCategory = null;
        ...
        <div class="mt-6">
            ...
            <div class="mt-4">
                ...
                <?php
                // Get brands related to music products
                $sql = "SELECT DISTINCT b.id, b.name FROM brands b 
                        JOIN products p ON p.brand_id = b.id 
                        JOIN categories c ON p.category_id = c.id 
                        WHERE c.name = 'Music' OR c.parent_id = (SELECT id FROM categories WHERE name = 'Music')
                        ORDER BY b.name";
    ...
    <div class="flex-1 p-4">
        ...
        <div class="mb-4 text-sm">
            ...
            <?php if (isset($_GET['subcategory'])): ?>
                <a href="category.php?slug=<?php echo $mainCategory['slug']; ?>" class="hover:text-red-600">Music</a> / 
